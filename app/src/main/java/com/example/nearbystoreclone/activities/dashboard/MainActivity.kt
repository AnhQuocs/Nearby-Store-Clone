...
import com.example.nearbystoreclone.viewmodel.DashboardViewModel
...
fun DashboardScreen() {
    ...
    systemUiController.setStatusBarColor(colorResource(R.color.blue))
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item { Banner(banners, showCategoryLoading) }
        }
    }
}