package com.example.nearbystoreclone.activities.dashboard
...
fun prepareBottomMenu(): List<BottomMenuItem> {
    ...
    bottomMenuItemList.add(BottomMenuItem(label = "Support", icon = painterResource(R.drawable.btn_2)))
    bottomMenuItemList.add(BottomMenuItem(label = "Wishlist", icon = painterResource(R.drawable.btn_3)))
    bottomMenuItemList.add(BottomMenuItem(label = "Profile", icon = painterResource(R.drawable.btn_4)))
